...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *path = [NSString stringWithFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/help"];
...
- (void)viewDidLoad
{
    ...
    helpTextView = [[UITextView alloc] initWithFrame:CGRectMake(10.0, 95.0, 310.0, 350.0)];
