...
@interface GetYoutooTv : UIViewController <UITextViewDelegate,NSXMLParserDelegate, CSMAdvertisingProtocol> {
  ...
  //  ASINetworkQueue			*networkQueue;    
    ...
    NSString *getYoutooTvString;
    UITextView *getYoutooTvTextView;
}
@property (nonatomic, retain) UITextView *getYoutooTvTextView;
...
@property (nonatomic, retain)  NSString *getYoutooTvString;
