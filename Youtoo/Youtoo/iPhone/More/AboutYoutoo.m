...
@interface AboutYoutoo (PrivateMethods)

- (void)didStopLoadData;
@end
@implementation AboutYoutoo
...
- (void)viewWillAppear:(BOOL)animated
{
   ...
   /* NSString *path = [NSString stringWithFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/about"];
...
//	NSTimeInterval definedTimeInterval = kUpdatePeriod;
	...
	//	[defaults setObject:[NSDate date] forKey:@"BlogPageLastUpdate"];
        ...
        [tempURLStr appendFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/about"];
...
{
    [super viewDidLoad];
    self.title = @"About Youtoo";
    activityIndicator = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(138, 180, 40, 40)];    
    [activityIndicator setActivityIndicatorViewStyle:UIActivityIndicatorViewStyleGray];
    [self.view addSubview:activityIndicator]; 
    aboutTextView = [[UITextView alloc] initWithFrame:CGRectMake(10.0, 95.0, 310.0, 350.0)];
    [aboutTextView setBackgroundColor:[UIColor clearColor]];
    [aboutTextView setFont:[UIFont systemFontOfSize:16.0]];
    aboutTextView.textColor=[UIColor colorWithRed:0.14 green:0.29 blue:0.42 alpha:1];
    [aboutTextView setText:@""];
    [aboutTextView setText:self.aboutString ];
...
//    NSLog(@"Content String:%@",self.aboutString);
//    aboutTextView.text = self.aboutString;
    // Do any additional setup after loading the view from its nib.
}
#pragma mark -
