...
@interface AboutYoutooCredits (PrivateMethods)

- (void)didStopLoadData;
@end
@implementation AboutYoutooCredits
...
@synthesize aboutCreditsString;
@synthesize aboutYoutooCredits;
...
- (void)viewWillAppear:(BOOL)animated
{
 ...
 /*   NSString *path = [NSString stringWithFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/credits"];
    NSLog(@"Credits URL: %@", path);    
...
//	NSDate *pageLastUpdate = [defaults objectForKey:@"BlogPageLastUpdate"];
	...
	//	[defaults setObject:[NSDate date] forKey:@"BlogPageLastUpdate"];
        ...
        [tempURLStr appendFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/credits"];
...
{
    [super viewDidLoad];
    self.title = @"About Youtoo Credits";
    activityIndicator = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(138, 180, 40, 40)];    
    [activityIndicator setActivityIndicatorViewStyle:UIActivityIndicatorViewStyleGray];
    [self.view addSubview:activityIndicator];  
    aboutYoutooCredits = [[UITextView alloc] initWithFrame:CGRectMake(10.0, 95.0, 320.0, 350.0)];
    [aboutYoutooCredits setBackgroundColor:[UIColor clearColor]];
    [aboutYoutooCredits setFont:[UIFont systemFontOfSize:16.0]];
    aboutYoutooCredits.textColor=[UIColor colorWithRed:0.14 green:0.29 blue:0.42 alpha:1];
    [aboutYoutooCredits setText:@""];
    [aboutYoutooCredits setText:self.aboutCreditsString ];
    [aboutYoutooCredits setEditable:NO];
    [self.view addSubview:aboutYoutooCredits];
...
{    
	...
	NSLog(@"Credits: %@", [request responseString]);
