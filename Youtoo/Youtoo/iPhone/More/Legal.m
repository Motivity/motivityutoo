...
@interface Legal (PrivateMethods)
...
@synthesize legalString;
@synthesize leagTextView;
...
/*    NSString *path = [NSString stringWithFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/legal"];
    NSLog(@"Constructed Legal URL: %@", path);    
...
//		[defaults setObject:[NSDate date] forKey:@"BlogPageLastUpdate"];
        ...
        [tempURLStr appendFormat:@"http://www.youtoo.com/iphoneyoutoo/showHelp/legal"];
...
- (void)viewDidLoad
{
    ...
    leagTextView = [[UITextView alloc] initWithFrame:CGRectMake(10.0, 95.0, 310.0, 350.0)];
    [leagTextView setBackgroundColor:[UIColor clearColor]];
    [leagTextView setFont:[UIFont systemFontOfSize:16.0]];
    leagTextView.textColor=[UIColor colorWithRed:0.14 green:0.29 blue:0.42 alpha:1];
    [leagTextView setText:@""];
    [leagTextView setText:self.legalString ];
    //friendTxtFld.tag = indexPath.row;
    [leagTextView setEditable:NO];
    [self.view addSubview:leagTextView];
