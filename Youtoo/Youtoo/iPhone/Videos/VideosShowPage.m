...
- (void)viewDidLoad
{
    ...
    titleLbl.text = myItemModel.showName;
    YoutooAppDelegate *appDelegate = (YoutooAppDelegate *)[UIApplication sharedApplication].delegate;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   /* static NSString *CellIdentifier = @"Cell";
    ...
    ItemModel *aModel = [self.itemStorage.storageList objectAtIndex:indexPath.row];
     UILabel *textLbl = [[UILabel alloc]initWithFrame: CGRectMake(80.0, 15.0, 220.0, 40.0)];
    textLbl.font = [UIFont boldSystemFontOfSize:19.0];
    [textLbl setBackgroundColor:[UIColor clearColor]];
	textLbl.textColor = [UIColor colorWithRed:0.015 green:0.2 blue:0.36 alpha:1];
    textLbl.text = aModel.episodeName;
    [cell.contentView addSubview:textLbl];
    UILabel *labelCell1 = [[UILabel alloc]initWithFrame:CGRectMake(7.0f, 16.0f, 60.0f,40.0f)];    //labelCell1.frame = CGRectMake(05.0f, 10.0f, 80.0f,30.0f) ;
    [labelCell1 setBackgroundColor:[UIColor clearColor]];
    labelCell1.font = [UIFont boldSystemFontOfSize:19.0];
	...
	UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(5.0f, 18.0f, 65.0f,40.0f)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    VideosShowDetailPage *selctdViewController = [ [VideosShowDetailPage alloc] initWithNibName:@"VideosShowDetailPage" bundle:nil :aModel];
